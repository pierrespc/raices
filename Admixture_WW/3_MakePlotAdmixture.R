...
#	outfile<-paste("chr1.1KG.PopArg.pruned.K",KNUM,".pdf",sep="")
  ...
  ###plot Africa
  plot(0,0,"n",ylim=c(0,1),xlim=c(0,(numInds+separPop*(numPops-numRegions)+numRegions*(separ)))*1.06,main=paste("K =", numberK),ann=F,axes=F)
  xleft=0
  atPop<-c()
  dimPrevRegion<- 0
  atRegion<-c()
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "Middle Easterns\nNorth Africans\nand Caucasians",cex=10)
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "East Asians\nCentral Asians",cex=10)
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "Central Asians\nCentral South Asians",cex=10)
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "Europeans",cex=10)
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "Oceanians\nGroenland\nNative Americans",cex=10)
  ...
  atRegion<-c()
  ITER = 0
  for(reg in c("AfroAmerican","Admixed American")){
          temp<-out[ out$Region == reg,]
          Population=temp$Population[1]
          ITER=ITER+1
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line=4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.06,y=0.5,labels = "Afro\nand\nAdmixed\nAmericans",cex=10)
  ...
  #axis(1,at=atRegion,label=names(atRegion),cex.axis=6,tick=F,line = 4)
  text(x=(numInds+separPop*(numPops-numRegions)+numRegions*(separ))*1.03,y=0.5,labels = "Present Study",cex=10)
