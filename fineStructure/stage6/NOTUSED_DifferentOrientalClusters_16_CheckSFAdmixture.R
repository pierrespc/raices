...
####How we combine SF: 
### Case 1 of grouping "Oriental" clusters as it
listCombSF<-list(
  "SubsaharanAfrica"=c("SouthernAfrica","EasternAfrica","GuineanGulf","WesternAfrica","WesternAfrica2"),
  "CentralSouthAsia"="CentralSouthAsia",
  "NorthAfricaCentralSouthAsia"="NorthAfricaCentralSouthAsia",
  "NorthAfricaLevant"="NorthAfricaLevant",
  "Caucasus"="Caucasus",
  "Levant"="Levant",
...
### Case 2 of grouping: Only "Oriental" clusters grouped when in clade AND when geographically consistent
listCombSF<-list(
  "SubsaharanAfrica"=c("SouthernAfrica","EasternAfrica","GuineanGulf","WesternAfrica","WesternAfrica2"),
  "CentralSouthAsia"="CentralSouthAsia",
  "NorthAfricaCentralSouthAsia"="NorthAfricaCentralSouthAsia",
  "NorthAfricaLevant"="NorthAfricaLevant",
  "CaucasusLevant"=c("Caucasus","Levant"),
  "Europe"=c("NorthEurope","Basque","WestEuropeCentralEurope","Sardinia","Italy","Spain"),
  "NativeAmerican"=c("CentralAmericaCentralAndes","SouthAmericanTropicalForests","NorthAmerica")
)


###Final choice  of grouping: All "Oriental" clusters grouped when in clade
listCombSF<-list(
  "SubsaharanAfrica"=c("SouthernAfrica","EasternAfrica","GuineanGulf","WesternAfrica","WesternAfrica2"),
  "CentralSouthAsiaNorthAfricaLevant"=c("NorthAfricaLevant","CentralSouthAsia"),
  "CentralSouthAsiaNorthAfrica"=c("NorthAfricaCentralSouthAsia"),
  "CaucasusLevant"=c("Caucasus","Levant"),
  "Europe"=c("NorthEurope","Basque","WestEuropeCentralEurope","Sardinia","Italy","Spain"),
  "NativeAmerican"=c("CentralAmericaCentralAndes","SouthAmericanTropicalForests","NorthAmerica")
)
...
colorLISTS[[paste("c",8)]]<-c("Europe"="darkorange",
      "CentralSouthAsia"="goldenrod2",
      "NorthAfricaCentralSouthAsia"="goldenrod4",
      "NorthAfricaLevant"="brown2",
      "Caucasus"="brown3",
      "Levant"="brown4",
...
colorLISTS[[paste("c",7)]]<-c("Europe"="darkorange",
      "CentralSouthAsia"="goldenrod2",
      "NorthAfricaCentralSouthAsia"="goldenrod4",
      "NorthAfricaLevant"="brown2",
      "CaucasusLevant"="brown3",
      "NativeAmerican"="cadetblue",
      "SubsaharanAfrica"="seagreen")


colorLISTS[[paste("c",6)]]<-c("Europe"="darkorange",
      "CentralSouthAsiaNorthAfrica"="goldenrod",
      "CaucasusLevant"="brown",
      "CentralSouthAsiaNorthAfricaLevant"="lightgoldenrod",
      "NativeAmerican"="cadetblue",
      "SubsaharanAfrica"="seagreen")
